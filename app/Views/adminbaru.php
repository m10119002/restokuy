    ...
    <div class="login-page">
        ...
        <div class="card position-absolute top-50 start-50 translate-middle col-4">
            <div class="card-body p-4">
                <h1 class="card-title text-center mb-4">ADMIN BARU</h1>
                <!-- Alert -->
            ...
            -->
                ...
                <?php echo form_open('xyz/new'); ?>
                    <div class="mb-3">
                        <label for="exampleInputUsername1" class="form-label">Username</label>
                        <?php if(isset($formData['username'])): ?>
                            <input type="username" class="form-control" id="exampleInputUsername1" name="username" value="<?php echo $formData['username']; ?>" required>
                    ...
                    <div class="mb-4">
                        ...
                        <?php if(isset($formData['password'])): ?>
                            <input type="password" class="form-control" id="exampleInputPassword1" name="password" value="<?php echo $formData['password']; ?>" required>
                    ...
                    <div class="mb-4">
                        <label for="exampleInputPassword2" class="form-label">Password Ulang</label>
                        <?php if(isset($formData['password_ulang'])): ?>
                            <input type="password" class="form-control" id="exampleInputPassword2" name="password_ulang" value="<?php echo $formData['password_ulang']; ?>" required>
                            ...
                            <?php else: ?>
                                <div class="valid-feedback d-block">
                                    Password Ulang sudah benar!
                                </div>
                            <?php endif ?>
                        <?php else: ?>
                            <input type="password" class="form-control" id="exampleInputPassword2" name="password_ulang" required>
                        <?php endif ?>
                    </div>
                    <div class="d-grid justify-content-center">
                        <button type="submit" class="btn btn-large bg--primary"><span class="font-btn font-white">Buat</span></button>
                    </div>
                <?php echo form_close(); ?>
                <!--</form>-->
            </div>
