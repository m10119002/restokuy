...
<body>
  ...
  <main class="container-fluid">
    <div class="row">
      ...
      <div class="col m-4">
        ...
        <a href="<?php echo base_url('pelayan/pesanan/tambah'); ?>" class="btn font-btn bg--third font-white my-4">Tambah</a>
        <!-- Alert -->
  ...
  -->
        <?php if (isset($tabel_pesanan)) : ?>
          <?php echo view('Pelayan/Pesanan/tabel_pesanan'); ?>
        <?php else : ?>
          Error: $tabel_pesanan tidak terdefinisi.
        <?php endif ?>
        <!-- Modal -->
        <?php echo view('Template/modal_konfirmasi-hapus', array('url' => base_url('pelayan/pesanan/hapus'))); ?>
      </div>
  </main>
