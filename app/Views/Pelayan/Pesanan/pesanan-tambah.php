...
<body>
  ...
  <main class="container-fluid">
    <div class="row">
      ...
      <div class="col m-4">
        ...
        <a href="<?php echo base_url('pelayan/pesanan'); ?>" class="btn font-btn bg--third font-white my-4">Pesanan</a>
        <!-- Alert -->
  ...
  -->
        <div class="row">
          <div class="col-5">
            <?php echo form_open('pelayan/pesanan/tambah'); ?>
            <!-- <form method="post" action=""> -->
              <?php echo view('Pelayan/pesanan/form'); ?>
          ...
          <div class="col border border-3 rounded">
            <div class="row row-cols-2 gy-3 py-3">
              <?php if (isset($kartu_menu)) : ?>
                <?php foreach ($kartu_menu as $row) : ?>
                  <?php echo view('Pelayan/pesanan/kartu'); ?>
                <?php endforeach ?>
              <?php else : ?>
                Error: $kartu_menu tidak terdefinisi.
              <?php endif ?>
            </div>
          </div>
  </main>
