...
<body>
  ...
  <main class="container-fluid">
    <div class="row">
      ...
      <div class="col m-5">
        <h2 class="font-primary">Tambah Data Pegawai</h2>
        <a href="<?php echo base_url('admin/pegawai'); ?>" class="btn font-btn bg--third font-white my-4">Pegawai</a>
        <!-- Alert -->
  ...
  -->
        ...
        <?php echo form_open('admin/pegawai/tambah'); ?>
          <?php
            $passData = [];
            if (isset($formData)) {
              $passData = [
