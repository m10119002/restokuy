...
<body>
  ...
  -->
        <?php if (isset($tabel_pegawai)) : ?>
          <?php if (count($tabel_pegawai) == 0) : ?>
            <?php echo view('Admin/Pegawai/tabel_pegawai'); ?>
          <?php else : ?>
            <?php echo view('Admin/Pegawai/tabel_pegawai', array('tabel_pegawai' => $tabel_pegawai)); ?>
          <?php endif ?>
        <?php else : ?>
          Error: $tabel_pegawai tidak terdefinisi.
        <?php endif ?>
        <!-- Modal -->
        <?php echo view('Template/modal_konfirmasi-hapus', array('url' => base_url('admin/pegawai/hapus'))); ?>
      </div>
    </div>
  </main>
