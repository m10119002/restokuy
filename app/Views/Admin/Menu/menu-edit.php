...
<body>
  ...
  -->
        <?php echo form_open('admin/menu/edit'); ?>
        <div class="row pt-5">
          <?php echo view('Admin\Menu\form', array('formData' => $formData)); ?>
          <div class="col-4 pb-4">
            <button type="submit" class="btn font-btn bg--primary font-white">EDIT</button>
          </div>
